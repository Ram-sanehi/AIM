      ...
      <div className="container mx-auto px-4 relative z-10 flex-grow flex items-center py-4">
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center w-full">
          ...
          <div className="lg:col-span-5 flex justify-center items-center relative mt-8 lg:mt-0">
            ...
            <div className="absolute -inset-16 bg-[radial-gradient(circle,_rgba(212,175,55,0.12)_0%,_transparent_70%)] rounded-full blur-3xl opacity-90 pointer-events-none z-0 animate-pulse" style={{ animationDuration: "10s" }} />
            ...
            >
              ...
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-72 h-72 rounded-full bg-[radial-gradient(circle,_rgba(212,175,55,0.1)_0%,_transparent_70%)] blur-[50px] pointer-events-none z-0 animate-pulse" style={{ animationDuration: "8s" }} />
